        ...
        function (e) {
            ...
            var F, I, M, A, O, L, B, z, N, U, W, G, K, i = "ScrollSmoother",
                ...
                t = (function (e) {
                    ...
                    return I || (F = e || r(), q() && window.document && (M = window, A = document, O = A.documentElement, L = A.body), F && (B = F.utils.toArray, z = F.utils.clamp, W = F.parseEase("expo"), N = F.core.globals().ScrollTrigger, F.core.globals("ScrollSmoother", ScrollSmoother), L && N && (G = N.core._getVelocityProp, K = N.core._inputObserver, ScrollSmoother.refresh = N.refresh, I = 1))),
                        I
                },
            ...
            function ScrollSmoother(e) {
                var o = this;
                I || ScrollSmoother.register(F) || console.warn("Please gsap.registerPlugin(ScrollSmoother)"),
                    e = this.vars = e || {},
                    U && U.kill(),
                    U = this;
                function Ca() {
                ...
                function Ia(e) {
                    return arguments.length ? (c ? k = -e : Ha(- e), H.y = -e, h = !0, x(e), this) : -k - x.offset
                }
                function Ka(e) {
                    v.scrollTop = 0,
                        b && !1 === b(o, e) || (N.isInViewport(e.target) || e.target === d || o.scrollTo(e.target, !1, "center center"), d = e.target)
                }
                function La(e) {
                    var r, n, o, i;
                ...
                function Qa(r, e, t, n) {
                    ...
                    return Eb(),
                        ...
                        })), F.core.getCache(i.trigger).stRevert = Oa, i.startY = h, i.pins = g, i.markers = p, i.ratio = o, i.autoSpeed = s, r.style.willChange = "transform"),
                        i
                }
                ...
                N.addEventListener("refresh", Ma),
                    ...
                    this.wrapper = function (e) {
                        return arguments.length ? (v = B(e || "#smooth-wrapper")[0] ||
                            function _wrap(e) {
                                var t = A.querySelector(".ScrollSmoother-wrapper");
                                return t || ((t = A.createElement("div")).classList.add("ScrollSmoother-wrapper"), e.parentNode.insertBefore(t, e), t.appendChild(e)),
                                    t
                    ...
                    this.effects = function (e, t) {
                        if (w = w || [], !e) return w.slice(0); (e = B(e)).forEach(function (e) {
                ...
                R.forEach(function (e) {
                    ...
                    N.config(e),
                    "overscrollBehavior" in M.getComputedStyle(L) && F.set([L, O], {
